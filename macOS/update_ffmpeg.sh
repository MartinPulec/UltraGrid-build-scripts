...
./configure --prefix=/usr/local/share/ffmpeg --enable-gpl --enable-nonfree --disable-sdl2 --enable-libx264  --enable-libx265  --enable-videotoolbox --enable-audiotoolbox --enable-libopus --enable-libspeex --enable-libvpx --enable-libfdk-aac # --enable-vda
...
./configure --prefix=/usr/local/share/ffmpeg-notoolbox --enable-gpl --enable-nonfree --disable-sdl2 --enable-libx264  --enable-libx265  --disable-videotoolbox --disable-audiotoolbox --enable-libopus --enable-libspeex --enable-libvpx --enable-libfdk-aac # --enable-vda
make -j 42 && sudo make install
